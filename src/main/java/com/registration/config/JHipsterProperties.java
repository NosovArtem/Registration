...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "registration@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "registration API";

        private String description = "registration API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "registration";
